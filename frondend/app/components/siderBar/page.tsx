        ...
        <nav className={style.sidebarNav}>
          ...
          <ul className={style.sidebarList}>
            ...
            <li>
              <Link
                ...
                className={`${style.navLink} ${pathname === "/dashboard/financeiro" ? style.active : ""}`}
              >
                <CreditCard size={18} />
            ...
            <li>
              <Link
                ...
                className={`${style.navLink} ${pathname === "/dashboard/relatorios" ? style.active : ""}`}
              >
                <BarChart3 size={18} />
          ...
          <ul className={style.sidebarList}>
            ...
            <li>
              <Link
                href="/ajuda"
                className={`${style.navLink} ${pathname === "/ajuda" ? style.active : ""}`}
              >
                <HelpCircle size={18} />
                <span>Ajuda</span>
              </Link>
